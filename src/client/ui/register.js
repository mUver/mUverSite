    ...
    return (
      <div className="register">
        ...
        <form className="registerForm" onSubmit={this.props.handleSubmit}>
          ...
          <input type="username" onChange={this.props.handleChange} id="usernameRegister" className="username" placeholder="Username" /> <br/>
          <label htmlFor="password" id="passwordLabel"> Password </label><br/>
          <input type="password" onChange={this.props.handleChange} id="passwordRegister" className="password" placeholder="Password" /><br/>
